...
Character::Character(const Character& other): name(other.name), position(other.position), points(other.points), type(other.type) {}
Character::~Character() {}
...
int Character::getType() {
    return type; // Return 0 for cowboy, 1 for ninjas
}
